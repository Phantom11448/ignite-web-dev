...
const IMAGES = [
  '/images/coldside-screenshot-1.png',
  '/images/signal-demo.mp4',
  '/3fs/intro.mp4',
  '/images/bizcheck-display-1.jpg',
  '/saltline/saltline-screenshot-1.jpg',
  '/images/neon-demo.mp4',
];
...
function extractColors(img, idx) {
  try {
    // Downscale image (or video frame) for faster processing
    const MAX = 48;
    const srcW = img.naturalWidth || img.videoWidth || 0;
    const srcH = img.naturalHeight || img.videoHeight || 0;
    ...
    // Draw image or current video frame to temporary canvas
