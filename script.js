...
(function() {
    ...
    const fragSrc = `
        ...
        void main() {
            ...
            vec3 colorB = vec3(0.72, 0.30, 0.11);
            vec3 colorC = vec3(1.0, 0.97, 0.93);

            vec3 col = mix(colorA, colorB, smoothstep(0.12, 0.88, pattern));
            col = mix(col, colorC, smoothstep(0.84, 0.99, n2) * 0.55);
